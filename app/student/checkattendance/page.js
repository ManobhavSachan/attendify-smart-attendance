...
import { useState } from 'react';import styles from '../../styles.module.css';
import Link from 'next/link';
import checkimage from '../../../Assets/checkatt.png';
import Image from 'next/image';
...
export default function AttendanceChecker() {
  ...
  const studentsData = [
    { rollNumber: 101, name: 'John Doe', attendance: 25 },
    { rollNumber: 102, name: 'Jane Smith', attendance: 85 },
    { rollNumber: 103, name: 'Alice Johnson', attendance: 60 },
    // Add more dummy data as needed
  ];

  const checkAttendance = () => {
    const student = studentsData.find(student => student.rollNumber === parseInt(rollNumber));
    if (student) {
